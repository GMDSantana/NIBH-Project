...
public:
        ...
        TFPrincipal *e_altura, *alfa, *area, *densidade, *me_lag, *me_intervalo_previsao, *v_inicial, *e2, *pl, *e3, *E1, *E4, *xinicial, *dt, *chkBoxVIL, *Checked, *d1, *d2, *SV_Dados, *lblNomeArquivo, *OD_Dados;
        int **vet_resultados;
        int *vet_altura;
