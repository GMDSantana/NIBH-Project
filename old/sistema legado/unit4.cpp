...
// else ShowMessage("erro");
            ...
            FPrincipal->edtDeltaVol->Caption = FormatFloat("0.0000", FPrincipal->DeltaVol);      //TControl: Caption <> Text
            FPrincipal->edtCorrel->Caption = FormatFloat("0.0000", FPrincipal->Correl);          //TControl
            FPrincipal->edtNash->Caption = FormatFloat("0.0000", FPrincipal->NashSutcliffe);     //TControl
